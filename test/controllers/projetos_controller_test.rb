...
class ProjetosControllerTest < ActionController::TestCase
  ...
  test "should create projeto" do
    assert_difference('Projeto.count') do
      post :create, projeto: { descricao: @projeto.descricao, integracao_continua: @projeto.integracao_continua, nome: @projeto.nome }
    end
  ...
  test "should update projeto" do
    patch :update, id: @projeto, projeto: { descricao: @projeto.descricao, integracao_continua: @projeto.integracao_continua, nome: @projeto.nome }
    assert_redirected_to projeto_path(assigns(:projeto))
  end
